...
public class PlaceCard extends LinearLayout {
    ...
    void setName(int name_resID) { name.setText(name_resID); }
    void setPhone(int phone_resID) { phone.setText(phone_resID);}
    void setLocation(int location_resID) { location.setText(location_resID); }
    void setBenefit1(int benefit1_resID) { benefit1.setText(benefit1_resID); }
    void setBenefit2(int benefit2_resID) { benefit2.setText(benefit2_resID); }
    void setImage(int image_resID) { image.setImageResource(image_resID); }
}
