...
public class ChattingActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public static String nickname, date, date_m, place, type, matching_id, meeting_id, partner_name, manager_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manager_name = "야미구 매니저 "+ intent.getExtras().getString("manager_name");
