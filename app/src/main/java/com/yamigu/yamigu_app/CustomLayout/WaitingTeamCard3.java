...
public class WaitingTeamCard3 extends LinearLayout {
    ...
    public WaitingTeamCard3(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
        getAttrs(attrs);

    }
    public WaitingTeamCard3(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        initView();
    ...
    private void initView() {
        ...
        View v = li.inflate(R.layout.meeting_team_request, this, false);
        addView(v);
